...
class ExternalIntegrationManager: ObservableObject {
    ...
    private func loadSampleConnections() {
        connections = [
            ...
            ServiceConnection(id: "oa-1", service: .openai, name: "Local MLX (兼容)", url: "http://localhost:8000/v1", token: "", isConnected: true, lastSync: Date(), config: ["model": "qwen3.5-9b-4bit"]),
        ]
    }
